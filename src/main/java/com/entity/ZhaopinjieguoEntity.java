...
public class ZhaopinjieguoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ZhaopinjieguoEntity() {
		
	}
	
	public ZhaopinjieguoEntity(T t) {
		try {
	 ...
	 * 设置：面试须知
	 */
	public void setMianshixuzhi(String mianshixuzhi) {
		this.mianshixuzhi = mianshixuzhi;
	}
	/**
	 * 获取：面试须知
	 */
	public String getMianshixuzhi() {
		return mianshixuzhi;
	}
	/**
	 * 设置：用户账号
